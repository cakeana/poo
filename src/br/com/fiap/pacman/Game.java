...
public class Game extends JFrame implements KeyListener {
	...
	private void run() {
		while (player.getLife() > 0) {
			...
			ghost3.mover();
			ghost4.mover();
			Integer p = player.getX() + player.getY();
			Integer g1 = ghost1.getX() + ghost1.getY();
			Integer g2 = ghost2.getX() + ghost2.getY();
			Integer g3 = ghost3.getX() + ghost3.getY();
			Integer g4 = ghost4.getX() + ghost4.getY();
			Integer b = booster.getX() + booster.getY();
			Integer bb = bomb.getX() + bomb.getY();

			if (p.equals(g1) || p.equals(g2) || p.equals(g3) || p.equals(g4)) {
